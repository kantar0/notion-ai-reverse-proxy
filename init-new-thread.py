...
print(f"🚀 Creando hilo inicial en la cuenta nueva (thread_id: {new_thread_id})...")
            ...
            },
            {
                ...
                "args": {
                    ...
                    "step": {
                        ...
                        "type": "user",
                        "userId": USER_ID,
                        "value": [["Hola Kimi, salúdame para verificar esta nueva cuenta"]],
                        "createdAt": iso_date
                    },
                    "parent_id": new_thread_id, "parent_table": "thread", "space_id": SPACE_ID,
                    "created_time": now_ms, "created_by_id": USER_ID, "created_by_table": "notion_user"
...
print("Status creacion Thread:", tx_res.status_code)
...
inf_payload = {
    ...
    "transcript": [
        ...
        {"id": user_id_step, "type": "user", "userId": USER_ID, "value": [["Hola Kimi, salúdame para verificar esta nueva cuenta"]], "createdAt": iso_date}
    ]
}
...
print("Status inferencia:", inf_res.status_code)
